import { require_react } from "/build/_shared/chunk-3CPB4T5C.js";
...
function useHref(to) {
    !useInRouterContext()
        ? true
            ...
            : invariant(false)
        : void 0;
    let { basename, navigator } = (0, import_react.useContext)(
        NavigationContext
    );
...
var Link = /* @__PURE__ */ (0, import_react2.forwardRef)(function LinkWithRef(
    _ref4,
    ref
) {
...
var NavLink = /* @__PURE__ */ (0, import_react2.forwardRef)(
...
var RemixCatchContext = /* @__PURE__ */ import_react3.default.createContext(
    void 0
);
function useCatch() {
...
function getLinksForMatches(matches, routeModules, manifest) {
    let descriptors = matches
        .map((match) => {
            ...
            return (
                ((_module$links = module.links) === null ||
                _module$links === void 0
                    ? void 0
...
function getNewMatchesForLinks(
    ...
    let matchPathChanged = (match, index) => {
        ...
        return (
            ...
            (((_currentMatches$index = currentMatches[index].route.path) ===
                null || _currentMatches$index === void 0
                ? void 0
...
function isFetchActionRedirect(location) {
    return (
        isRedirectLocation(location) && location.state.type === "fetchAction"
    );
}
function isLoaderSubmissionRedirectLocation(location) {
    return (
        isRedirectLocation(location) &&
        location.state.type === "loaderSubmission"
    );
}
...
function createTransitionManager(init) {
        ...
        switch (event.type) {
            case "navigation": {
                ...
                if (!matches2) {
                    ...
                    await handleActionSubmissionNavigation(
                        location,
                        submission,
                        matches2
                    );
                } else if (submission && isLoaderSubmission(submission)) {
                    await handleLoaderSubmissionNavigation(
                        location,
                        submission,
                        matches2
                    );
            ...
            case "fetcher": {
                ...
                if (submission && isActionSubmission(submission)) {
                    ...
                    await handleLoaderFetchSubmission(
                        href,
                        key,
                        submission,
                        match
    ...
    async function maybeBailOnCatch(match, key, result) {
        if (isCatchResult(result)) {
            let catchBoundaryId = findNearestCatchBoundary(
                match,
                state.matches
            );
            state.fetchers.delete(key);
    ...
    async function handleActionSubmissionNavigation(
        ...
        if (
            ...
            actionMatches[matches2.length - 1].route.index
        ) {
    ...
    async function loadPageData(
        ...
        let maybeActionErrorResult =
            actionResult && isErrorResult(actionResult) ? actionResult : void 0;
...
function filterMatchesToLoad(
    ...
    let matchPathChanged = (match, index) => {
        ...
        return (
            ...
            (((_state$matches$index$ = state.matches[index].route.path) ===
                null || _state$matches$index$ === void 0
                ? void 0
...
async function findCatchAndBoundaryId(results, matches, actionCatchResult) {
    ...
    if (actionCatchResult && loaderCatchResult) {
        let boundaryId = findNearestCatchBoundary(
            loaderCatchResult.match,
            matches
        );
...
function createShouldReload(route, routeModules) {
    let shouldReload = (arg) => {
        ...
        invariant2(
            module,
            `Expected route module to be loaded for ${route.id}`
        );
...
function RemixEntry({
    ...
    let [transitionManager] = React2.useState(() => {
        return createTransitionManager({
            ...
            catchBoundaryId:
                entryComponentDidCatchEmulator.catchBoundaryRouteId,
...
function useRemixRouteContext() {
    ...
    invariant2(
        context,
        "You must render this element in a remix route element"
    );
    return context;
}
...
function RemixRoute({ id }) {
    ...
    let element = Component
        ...
        : /* @__PURE__ */ React2.createElement(DefaultRouteComponent, {
              id,
          });
    let context = {
        data,
...
var NavLink2 = /* @__PURE__ */ React2.forwardRef(
    ({ to, prefetch = "none", ...props }, forwardedRef) => {
        ...
        return /* @__PURE__ */ React2.createElement(
            ...
            shouldPrefetch
                ? /* @__PURE__ */ React2.createElement(PrefetchPageLinks, {
                      page: href,
                  })
                : null
        );
 ...
 * @license MIT
 */
//# sourceMappingURL=/build/_shared/chunk-57HXC7CF.js.map
